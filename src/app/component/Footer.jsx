                ...
                <div className="container">
                    <div className="grid grid-cols-3 gap-2">
                        ...
                        <div className='text-center px-12.5'>
                            <Image src="/images/logo-white.avif" alt="logo" width={250} height={84} className='mx-auto'/>
                            <h2 className='text-white mt-2 mb-1 font-bold text-2xl'>STAY IN THE LOOP</h2>
                            ...
                            <form action="#">
                                <div className='flex justify-between mb-3 mt-5 px-5'>
