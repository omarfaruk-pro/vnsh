        ...
        <>
            <section className='pt-12 pb-9'>
                <div className="container">
                    <h2 data-aos="fade-up" className='text-[2.5rem] leading-[1.3] uppercase'>OUR CONTEST WINNERS</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 pt-12 pb-9">
                        <div className='text-center px-3.75' data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div className='text-center px-3.75' data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div className='text-center px-3.75' data-aos="fade-up" data-aos-delay="400">
